...
// alert("poop1 user_score_get : " + user_score_get);
...
// alert("poop1 grade : " + grade);
// alert("poop1 language : " + language);
...
function Clear() {
    ...
    location.href = `poop2.html?${"1"}?${"2"}?${time}?${grade}?${language}?${user_score}`;
}
